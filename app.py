...
img = Image.open('Olympic_rings.png')
st.sidebar.image(img)
# basic code -> skeleton of web app
...
if user_menu == 'Overall Analysis':
    ...
    sport_list = df['Sport'].unique().tolist()  # fetch the all unique value in sport column
    sport_list.sort()
